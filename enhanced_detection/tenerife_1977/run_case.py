#!/usr/bin/env python3
"""Run the Tenerife 1977 backtest."""
...
from enhanced_detection.tenerife_1977.config import INCIDENT
from enhanced_detection.tenerife_1977.clearances import CLEARANCES
